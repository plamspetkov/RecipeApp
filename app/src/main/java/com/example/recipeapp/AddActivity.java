...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextIngredients = findViewById(R.id.edit_text_ingredients);
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Upload upload = new Upload(mEditTextRecipeName.getText().toString().trim(),
                                    mEditTextIngredients.getText().toString().trim(),
                                    mEditTextDescription.getText().toString().trim(),
                                    taskSnapshot.getStorage().getDownloadUrl().toString()); //problem with .getDownloadUrl()
